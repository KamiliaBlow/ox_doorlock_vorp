...
const ItemsModal: React.FC<Props> = ({ modal, setModal }) => {
  ...
  return (
    <form onSubmit={form.onSubmit((values) => handleSubmit(values))}>
      <Stack>
        <TextInput label="Metadata type" defaultValue={itemData.metadata || undefined} {...form.getInputProps('metadata')} />
        <Switch label="Remove on use" defaultChecked={itemData.remove !== null ? itemData.remove : undefined} {...form.getInputProps('remove')} />
